...
public interface CalculatorListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code StatWhoCares}
	 * labeled alternative in {@link CalculatorParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterStatWhoCares(CalculatorParser.StatWhoCaresContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StatWhoCares}
	 * labeled alternative in {@link CalculatorParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitStatWhoCares(CalculatorParser.StatWhoCaresContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterExprVariable(CalculatorParser.ExprVariableContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprVariable}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitExprVariable(CalculatorParser.ExprVariableContext ctx);
}